...
class HtmlPostProcessorTest {
    ...
    void usePlantumlMacroShouldReplaceContent() throws IOException, URISyntaxException {
        ...
        String expected =
                "<ac:structured-macro ac:name=\"info\"><ac:rich-text-body>this include plantuml diagram will "
                        + "be convert to  confluence plantuml macro</ac:rich-text-body></ac:structured-macro>\n"
                        + "<ac:structured-macro ac:name='plantuml' ac:schema-version='1' "
                        + "ac:macro-id='c93806da-006e-4cfa-9d67-bfe2f255e2fb'>\n"
