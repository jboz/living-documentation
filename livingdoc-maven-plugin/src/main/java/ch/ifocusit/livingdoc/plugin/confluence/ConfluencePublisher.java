...
package ch.ifocusit.livingdoc.plugin.confluence;

import ch.ifocusit.livingdoc.plugin.confluence.client.ConfluenceAttachment;
import ch.ifocusit.livingdoc.plugin.confluence.client.ConfluenceClient;
import ch.ifocusit.livingdoc.plugin.confluence.client.ConfluencePage;
import ch.ifocusit.livingdoc.plugin.confluence.client.NotFoundException;
...
import static ch.ifocusit.livingdoc.plugin.confluence.utils.AssertUtils.assertMandatoryParameter;
import static ch.ifocusit.livingdoc.plugin.confluence.utils.InputStreamUtils.fileContent;
