...
import ch.ifocusit.livingdoc.plugin.confluence.client.payloads.*;
...
import static ch.ifocusit.livingdoc.plugin.confluence.client.HttpRequestFactory.PagePayloadBuilder.pagePayloadBuilder;
