...
image:https://img.shields.io/maven-central/v/org.apache.maven/apache-maven.svg["Maven Central", link="https://maven-badges.herokuapp.com/maven-central/ch.ifocusit.livingdoc/livingdoc-maven-plugin"]
